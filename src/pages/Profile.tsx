        ...
        <div className="container max-w-4xl">
          <div className="card-tactile p-6">
            ...
            <div className="flex items-start gap-4">
              <div className="w-20 h-20 rounded-full bg-primary flex items-center justify-center text-primary-foreground text-4xl shrink-0">
                {seller.avatar}
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  <h1 className="font-display text-xl font-bold text-foreground">{seller.username}</h1>
                  {seller.verified && (
            ...
            {/* Bio */}
            <p className="text-sm text-muted-foreground mt-4">{seller.bio}</p>
            ...
            <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t border-border">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-foreground">{seller.totalReviews}</div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-4 pt-4 border-t border-border">
              ...
              <div className="flex gap-2 sm:ml-auto">
                <Button size="sm" variant="outline" className="gap-2" onClick={() => setIsReviewOpen(true)}>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="space-y-3">
            {mockReviews.map((review) => (
              <div key={review.id} className="card-tactile p-4">
                <div className="flex items-start gap-3">
                  <Link to={`/profile/${review.reviewerId}`} className="shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <Link to={`/profile/${review.reviewerId}`} className="font-medium text-foreground hover:text-primary transition-colors">
                        {review.reviewer}
                      </Link>
