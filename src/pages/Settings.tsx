      ...
      <main className="container px-4 pb-8">
        <div className="max-w-2xl mx-auto">
          ...
          <section className="card-tactile p-6 mb-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 mb-4">
                ...
                <Button variant="outline" size="sm" onClick={() => setAvatarDialogOpen(true)}>Change Avatar</Button>
              </div>
          ...
          <section className="card-tactile p-6 mb-6">
            ...
            <div className="space-y-4">
              {[
                { key: "tradeOffers" as const, label: "Trade Offers", desc: "Get notified when someone wants to trade" },
                { key: "messages" as const, label: "Messages", desc: "New message notifications" },
                { key: "priceDrops" as const, label: "Price Drops", desc: "When saved items go on sale" },
                { key: "newListings" as const, label: "New Listings", desc: "Pins matching your interests" },
                { key: "newsletter" as const, label: "Newsletter", desc: "Weekly pin collecting tips and trends" },
                { key: "pushEnabled" as const, label: "Push Notifications", desc: "Enable browser push notifications" },
              ].map((item) => (
          ...
          <section className="card-tactile p-6 mb-6">
            ...
            <div className="space-y-4">
              {[
                ...
                { key: "showLocation" as const, label: "Show Location", desc: "Display your city on listings" },
                { key: "showEmail" as const, label: "Show Email", desc: "Let other users see your email" },
                { key: "showPhone" as const, label: "Show Phone", desc: "Let other users see your phone number" },
              ].map((item) => (
                <div key={item.key} className="flex items-center justify-between py-2">
                  <div>
                    <div className="text-sm font-medium text-foreground">{item.label}</div>
