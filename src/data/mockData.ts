...
export const mockPins: Pin[] = [
  {
    ...
    isFavorite: true,
    category: "disney",
    description: "Beautiful 50th anniversary Mickey Mouse pin in pristine condition. Features gold plating and limited edition numbering.",
    listingType: "sell",
  ...
  },
  {
    ...
    isTradeOnly: true,
    category: "disney",
    description: "Adorable Stitch pin with the iconic 'Ohana Means Family' quote.",
    listingType: "trade",
  ...
  },
  {
    ...
    isFavorite: true,
    category: "starwars",
    description: "Brand new Baby Yoda/Grogu pin from The Mandalorian collection.",
    listingType: "sell",
  ...
  },
  {
    ...
    isFavorite: true,
    category: "disney",
    description: "Stunning Cinderella Castle 70th anniversary commemorative pin.",
    listingType: "sell",
  ...
  },
  {
    ...
    isTradeOnly: false,
    category: "marvel",
    description: "Complete Avengers Endgame pin collection featuring all original Avengers.",
    listingType: "sell",
